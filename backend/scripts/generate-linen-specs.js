...
const shirtFeatures = (color, sleeve = 'short') => [
  ...
  'Relaxed drape with ELIJAY'S Men's Wear tailoring finish.',
...
const make = (name, color, brand, price, featured = false, intro, sleeve = 'short') => ({
  ...
  sleeve,
  description: rich(
    intro || `${name} — premium men's linen shirt crafted for breathable summer elegance at ELIJAY'S Men's Wear.`,
