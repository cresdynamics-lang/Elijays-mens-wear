...
const poloFeatures = (color) => [
  ...
  'Fine-gauge knit texture with premium ELIJAY'S Men's Wear finish.',
...
const make = (name, color, brand, price, featured = false, intro) => ({
  ...
  featured,
  description: rich(
    intro || `${name} â€” refined men's knitted polo combining breathable comfort with polished ELIJAY'S Men's Wear style.`,
    poloFeatures(color),
    fit
  ),
});
