...
const fmt = (intro, features) =>
  `${intro}\n\nKey features:\n${features.map((f) => `• ${f}`).join('\n')}\n\nAvailable waist sizes 30–40. Tailored at ELIJAY'S Men's Wear for smart-casual, office, and weekend wear.`;
...
const SPECS = {
  '508132770466494258': {
    ...
    price: 6200,
    description: fmt(
      'Textured light grey tailored khakis with a heathered weave — sharp centre crease, flat-front cut, and refined ELIJAY'S Men's Wear finishing for office-ready style.',
      [
  ...
  Beige_caqui: {
    ...
    description: fmt(
      ...
      [
        ...
        'Pairs with ELIJAY'S Men's Wear shirts and polos.',
      ]
    ),
  },
  ...
  Luxire__1_: {
    ...
    featured: true,
    description: fmt(
      'Premium khaki trousers with Gurkha-style side adjusters — high-rise tailored cut, turn-up cuffs, and sartorial ELIJAY'S Men's Wear detailing.',
      [
