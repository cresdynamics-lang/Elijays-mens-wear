...
const buildDescription = (meta) => {
  const intro = `ELIJAY'S Men's Wear ${meta.color.toLowerCase()} ${meta.style.replace(/-/g, ' ')} khaki trousers — ${meta.fit} fit cotton twill built for smart-casual, office, and weekend wear.`;
  const features = [
