...
const fmt = (intro, features) =>
  `${intro}\n\nKey features:\n${features.map((f) => `• ${f}`).join('\n')}\n\nAvailable sizes S–3XL (jacket & trouser set). Tailored at ELIJAY'S Men's Wear for weddings, galas, and executive occasions.`;
...
const SPECS = {
  ...
  'Custom_White_Two-Piece_Suit___Formal_Wedding_Outfit_groom_outfit': {
    ...
    description: fmt(
      ...
      [
        ...
        'Pairs beautifully with ELIJAY'S Men's Wear dress shirts and silk ties.',
      ]
    ),
  },
  ...
  'Formal_Men_s_Suits_2_Piece_Slim_Fit_Performance_Suit_-_Brown___M': {
    ...
    price: 24800,
    description: fmt(
      'Rich cognac brown in a slim-fit two-piece cut — warm, confident, and distinctly ELIJAY'S Men's Wear for autumn weddings and smart executive dressing.',
      [
  ...
  Menseventwear_Formal_Men_s_2_Pieces_Solid_Slim_Fit_Peak_Lapel_Mens_Suit__Blazer_Pants_: {
    ...
    description: fmt(
      ...
      [
        ...
        'Formal eventwear staple from ELIJAY'S Men's Wear.',
      ]
    ),
  },
  ...
  Vinci___Exclusive_Menswear_Collection_Redefining_Contemporary_Elegance: {
    ...
    description: fmt(
      ...
      [
        ...
        'Redefining modern formalwear for ELIJAY'S Men's Wear clients.',
      ]
    ),
  },
  Best_Italian_suit_for_men_s___: {
    ...
    description: fmt(
      ...
      [
        ...
        'Matching trousers with tapered leg.',
        'The pinnacle of ELIJAY'S Men's Wear formal dressing.',
      ]
    ),
  },
