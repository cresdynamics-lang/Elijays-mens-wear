...
const fmt = (intro, features) =>
  `${intro}\n\nKey features:\n${features.map((f) => `• ${f}`).join('\n')}\n\nAvailable sizes M–3XL. Pair with ELIJAY'S Men's Wear trousers or denim for a complete look.`;
  ...
  '12_Hottest_Men_s_Dress_Shirts_to_Wear_for_Formal_Occasions': {
    ...
    description: fmt(
      ...
      [
        ...
        'Tailored fit that layers seamlessly under ELIJAY'S Men's Wear blazers.',
      ]
    ),
  },
  '146789269100262103': {
...
const DESCRIPTIVE = {
  ...
  Herrenhemd_Langarm_Paisleymuster_aus_Hochwertigem_Material__1_: {
    ...
    description: fmt(
      ...
      ['Detailed paisley pattern with jewel-tone accents.', 'Structured dress-shirt collar and placket.', 'Premium fabric with refined drape.', 'Single-button cuffs for classic formal finish.', 'Pairs with ELIJAY'S Men's Wear blazers and dress trousers.'],
    ),
  },
  ...
  Uiriuy_Mens_Casual_Collared_Short_Sleeve_Button_Down_Corduroy_Shirts__: {
    ...
    price: 6800,
    description: fmt(
      'Variant of our dusty blue corduroy camp-collar shirt — same fine wale texture and rolled cuffs in ELIJAY'S Men's Wear casual collection.',
  ...
  'link_below_____Classic_Navy_Striped_Shirt_for_Men___Smart_Casual_Essential': {
    ...
    description: fmt(
      ...
      ['Navy and white vertical stripe pattern.', 'Smart-casual essential for every wardrobe.', 'Long-sleeve with buttoned cuffs.', 'Crisp collar for tie or open-neck.', 'Pairs with chinos and ELIJAY'S Men's Wear blazers.'],
    ),
  },
};
