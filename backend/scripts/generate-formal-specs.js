  ...
  '126523070765874279': {
    ...
    description: fmt(
      ...
      [
        ...
        'Pairs with ELIJAY'S Men's Wear blazers and dress shirts.',
      ]
    ),
  },
  '309200330662136158': {
  ...
  Adjustable_gentlemans_trouser_ready_for_order_: {
    ...
    description: fmt(
      ...
      [
        ...
        'Clean ELIJAY'S Men's Wear tailoring lines.',
      ]
    ),
  },
  ...
  'UNINUKOO_Mens_Dress_Pants_Slim_Fit_Solid_Color_Skinny_Trousers_Classic_Business_Casual_Wedding_Suit_Pants__1_': {
    ...
    description: fmt(
      ...
      [
        ...
        'Pairs with ELIJAY'S Men's Wear formal shirts.',
      ]
    ),
  },
  Italian_Linen: {
  ...
  Luxire: {
    ...
    description: fmt(
      ...
      [
        ...
        'Luxury formal separate from ELIJAY'S Men's Wear.',
      ]
    ),
  },
};
