...
SET name = 'Classic Pique Polo in Black',
    ...
    updated_at = NOW()
WHERE slug = 'elijays-mens-wear-polo-black';
...
SET name = 'Classic Pique Polo in Brown',
    ...
    updated_at = NOW()
WHERE slug = 'elijays-mens-wear-polo-brown';
...
SET name = 'Classic Pique Polo in Dark Black',
    ...
    updated_at = NOW()
WHERE slug = 'elijays-mens-wear-polo-dark-black';
...
SET name = 'Classic Pique Polo in Light Blue',
    ...
    updated_at = NOW()
WHERE slug = 'elijays-mens-wear-polo-light-blue';
...
SET name = 'Classic Pique Polo in Red',
    ...
    updated_at = NOW()
WHERE slug = 'elijays-mens-wear-polo-red';
...
SET name = 'Classic Pique Polo in White',
    ...
    updated_at = NOW()
WHERE slug = 'elijays-mens-wear-polo-white';