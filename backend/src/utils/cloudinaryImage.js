/**
 * Cloudinary URL helpers — preset folder: elijays-mens-wear
 */

const UPLOAD_PRESET = process.env.CLOUDINARY_UPLOAD_PRESET || 'ELIJAYS';
const UPLOAD_FOLDER = process.env.CLOUDINARY_FOLDER || 'ELIJAYS';
