...
const ProductsView = () => {
 ...
 <div>
 <h3 className="text-lg sm:text-xl font-serif font-bold text-secondary ">
 ...
 <div className="flex flex-wrap gap-3 p-4 bg-utility-gray border border-utility-gray/60 rounded-2xl">
 ...
 className="w-full pl-9 pr-3 py-2.5 bg-primary border border-utility-gray/60 rounded-xl text-secondary text-sm outline-none focus:border-accent-500/40"
 />
 </div>
 <select
 ...
 className="bg-primary border border-utility-gray/60 rounded-xl px-3 py-2.5 text-secondary text-sm"
 >
 ...
 className="px-3 py-1.5 text-xs font-black border border-green-500/30 text-green-600 rounded-lg hover:bg-utility-gray disabled:opacity-50"
 >
 Publish
 </button>
 <button
 ...
 className="px-3 py-1.5 text-xs font-black border border-utility-gray/60 text-accent/80 rounded-lg hover:bg-utility-gray disabled:opacity-50"
 >
 Unpublish
 </button>
 <button
 ...
 className="px-3 py-1.5 text-xs font-black border border-red-500/40 text-red-600 rounded-lg hover:bg-red-400/10 disabled:opacity-50"
 >
 ...
 className="ml-auto text-xs text-secondary/50 hover:text-accent-400 underline"
 >
 Clear selection
 </button>
 </div>
 ...
 <div className="bg-utility-gray border border-utility-gray/60 rounded-2xl overflow-hidden backdrop-blur-sm text-secondary">
 {loading ? (
 ...
 className="w-4 h-4 rounded border-accent-500/30 bg-primary text-accent-600 focus:ring-0"
 />
 </th>
 ...
 <tr
 key={p.id}
 className={`hover:bg-utility-gray transition-colors ${selectedIds.has(p.id) ? 'bg-accent-600/5' : ''}`}
 >
 ...
 <div className="w-12 h-12 bg-utility-gray rounded-xl border border-utility-gray/60 overflow-hidden flex items-center justify-center">
 ...
 <ShoppingBag size={24} className="text-secondary/60" />
 )}
 </div>
 <div>
 <div className="text-sm font-bold text-secondary ">{p.name}</div>
 <div className="text-[10px] font-mono text-secondary/60 mt-1">{p.slug}</div>
 </div>
 </div>
 </td>
 ...
 <p className="text-[9px] text-secondary/60 mt-1 tracking-wider">
 {variantColors.length} color{variantColors.length !== 1 ? 's' : ''}
 </p>
 )}
 </td>
 <td className="px-6 py-4">
 <span className={`text-[10px] font-bold px-2 py-1 rounded-full ${p.is_active ? 'bg-green-400/10 text-green-600' : 'bg-utility-gray text-secondary/70'}`}>
 ...
 className="p-2 text-accent/80 hover:text-accent-500 hover:bg-utility-gray rounded-lg transition-all"
 >
 <Edit size={16} />
 </button>
 <button 
 ...
 className="p-2 text-red-600 hover:text-red-600 hover:bg-red-400/10 rounded-lg transition-all disabled:opacity-40"
 >
 ...
 {/* Product Modal */}
 {isModalOpen && (
 <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center p-0 sm:p-4 lg:p-6 bg-primary backdrop-blur-sm">
 <motion.div 
 initial={{ opacity: 0, scale: 0.95 }}
 animate={{ opacity: 1, scale: 1 }}
 className="bg-utility-gray border border-utility-gray/60 rounded-t-3xl sm:rounded-3xl p-4 sm:p-6 lg:p-8 w-full max-w-5xl max-h-[95vh] sm:max-h-[90vh] overflow-y-auto shadow-2xl custom-scrollbar"
 >
 <div className="flex items-center justify-between mb-8">
 <h4 className="text-2xl font-serif font-bold text-secondary ">
 {currentProduct ? 'Edit Product' : 'Add New Product'}
 </h4>
 <button type="button" onClick={closeProductModal} className="text-secondary/60 hover:text-accent-500">
 <X size={24} />
 </button>
 </div>
 ...
 <h5 className="text-xs font-black text-accent-500 tracking-[0.3em] border-b border-utility-gray/60 pb-2">General Information</h5>

 <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
 <div className="space-y-2">
 <label className="text-[10px] text-secondary/60 font-black">Product Name</label>
 <input 
 type="text" 
 required
 value={formData.name}
 ...
 className="w-full bg-primary border border-utility-gray/60 rounded-xl py-3 px-4 text-secondary outline-none focus:border-accent-500/40 transition-all"
 />
 </div>
 </div>
 ...
 <>
 <div className="space-y-2">
 <label className="text-[10px] text-secondary/60 font-black">Retail Price (KSh)</label>
 <input
 type="number"
 min="0"
 required
 ...
 <div className="space-y-2">
 <label className="text-[10px] text-secondary/60 font-black">Cost Price (KSh)</label>
 <input
 type="number"
 min="0"
 ...
 <div className="md:col-span-2 rounded-xl border border-utility-gray/60 bg-primary p-4 flex flex-col justify-center">
 <p className="text-[10px] text-secondary/60 font-black mb-1">Profit estimate</p>
 {(() => {
 ...
 <span className="text-secondary/70">Margin {margin}%</span>
 </div>
 );
 })()}
 </div>
 ...
 <>
 <div className="space-y-2">
 <label className="text-[10px] text-secondary/60 font-black">Website Price (KSh)</label>
 <input
 type="number"
 required
 value={formData.price}
 ...
 <div className="space-y-2">
 <label className="text-[10px] text-secondary/60 font-black">POS / Shop Price (KSh)</label>
 <input
 type="number"
 min="0"
 ...
 {!currentProduct && (
 <div className="rounded-2xl border border-utility-gray/60 bg-primary p-5 space-y-4">
 ...
 className={`relative h-8 w-16 rounded-full border transition-all ${formData.show_offer ? 'bg-accent-600 border-accent-500' : 'bg-utility-gray border-utility-gray/60'}`}
 ...
 {formData.show_offer && (
 <div className="space-y-2">
 <label className="text-[10px] text-secondary/60 font-black">Offer Price (KSh)</label>
 <input
 type="number"
 min="0"
 ...
 ? 'border-accent bg-accent-600/10 text-secondary'
 : 'border-utility-gray/60 bg-utility-gray text-accent/80 hover:border-accent-500/30'
 }`}
 >
 <input
 type="checkbox"
 ...
 {/* Media Section */}
 <div className="space-y-6">
 <h5 className="text-xs font-black text-accent-500 tracking-[0.3em] border-b border-utility-gray/60 pb-2">Product Media</h5>
 <div className="space-y-4">
 <div className="space-y-2">
 <label className="text-[10px] text-secondary/60 font-black">Main Thumbnail</label>
 <div className="flex items-center gap-6 p-6 bg-primary border-2 border-dashed border-utility-gray/60 rounded-2xl group hover:border-accent-500/30 transition-all relative">
 {uploading && (
 <div className="absolute inset-0 bg-primary backdrop-blur-[2px] z-20 flex items-center justify-center rounded-2xl">
 ...
 <div className="w-24 h-24 rounded-xl border border-utility-gray/60 overflow-hidden bg-utility-gray flex items-center justify-center relative group">
 ...
 className="absolute inset-0 bg-red-500/40 text-secondary flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity"
 >
 <Trash2 size={20} />
 </button>
 </>
 ...
 <label className="text-[10px] text-secondary/60 font-black">Additional Gallery Images</label>
 <div className="relative">
 <button type="button" className="text-[10px] text-accent-500 hover:text-secondary font-black flex items-center gap-2 transition-colors">
 ...
 <div key={item.id || item.preview || idx} className="aspect-square rounded-xl border border-utility-gray/60 overflow-hidden relative group">
 ...
 className="absolute top-2 right-2 p-1.5 bg-red-500 text-secondary rounded-lg opacity-0 group-hover:opacity-100 transition-all shadow-lg"
 >
 <Trash2 size={14} />
 </button>
 </div>
 ...
 <div className="space-y-6">
 <div className="flex items-center justify-between border-b border-utility-gray/60 pb-2">
 <div>
 <h5 className="text-xs font-black text-accent-500 tracking-[0.3em]">Colors & Sizes</h5>
 <p className="text-[9px] text-secondary/60 tracking-wider mt-1">
 ...
 className="flex items-center gap-1 text-[10px] text-accent-400 hover:text-secondary font-black "
 >
 <Plus size={14} /> Add color
 </button>
 </div>

 <div className="bg-primary border border-accent-500/15 rounded-2xl p-6 space-y-5">
 <div className="space-y-2">
 <label className="text-[10px] text-secondary/60 font-black">Base SKU</label>
 <input
 type="text"
 required
 ...
 className="w-full bg-utility-gray border border-accent-500/5 rounded-lg py-3 px-4 text-secondary text-[11px] outline-none focus:border-utility-gray/60 font-bold font-mono"
 />
 </div>

 {formData.color_groups.map((group) => (
 <div key={group._key} className="border border-accent-500/15 rounded-xl p-4 space-y-4 bg-utility-gray">
 <div className="flex flex-wrap gap-3 items-start">
 <div className="flex-1 min-w-[160px] space-y-1">
 <label className="text-[10px] text-secondary/60 font-black">Color name</label>
 <input
 type="text"
 ...
 className="text-red-600 hover:text-red-600 p-2 mt-5"
 >
 <Trash2 size={16} />
 </button>
 )}
 ...
 <div className="space-y-2">
 <label className="text-[10px] text-secondary/60 font-black">Sizes for this color</label>
 ...
 className="max-w-[120px] bg-primary border border-utility-gray/60 rounded-lg py-2 px-3 text-secondary text-[10px] outline-none"
 />
 <button
 type="button"
 ...
 <thead className="text-secondary/60">
 <tr>
 ...
 <tbody>
 {group.sizes.map((row) => (
 <tr key={row._key} className="border-t border-utility-gray/60">
 <td className="p-2 font-bold text-secondary">{row.size}</td>
 <td className="p-2 text-right">
 <button type="button" onClick={() => removeSizeFromGroup(group._key, row._key)} className="text-red-600 hover:text-red-600">
 <Trash2 size={14} />
 </button>
 </td>
 </tr>
 ...
 {/* Status & Submit */}
 <div className="pt-10 border-t border-utility-gray/60 flex flex-col md:flex-row items-center justify-between gap-8">
 ...
 />
 <span className="text-[10px] font-black text-secondary group-hover:text-accent-500 transition-colors">Featured (homepage carousel)</span>
 </label>
 {canPublish && (
 <label className="flex items-center gap-3 cursor-pointer group">
 <input 
 ...
 className="w-4 h-4 rounded border-utility-gray/60 bg-primary text-accent-600 focus:ring-0 focus:ring-offset-0"
 />
 <span className="text-[10px] font-black text-secondary group-hover:text-accent-500 transition-colors">Active / Published</span>
 </label>
 )}
 </div>
 ...
 className="px-8 py-4 bg-utility-gray text-accent/80 rounded-xl font-black tracking-[0.2em] hover:bg-base-700 hover:text-accent-500 transition-all border border-utility-gray/60"
 >
 Cancel
 </button>
 <button 
