...
const HeroSlider = ({ heroSlides }) => {
 ...
 return (
  <section className="hero-section relative min-h-[90vh] bg-primary overflow-hidden">
 ...
 <div className="flex items-center space-x-4">
  ...
  <p className="text-accent/70 tracking-[0.4em] text-[10px] font-bold uppercase">
 {slide.subtitle}
 </p>
 </div>
 ...
 onClick={() => setCurrent(i)}
  className={`h-[3px] transition-all duration-500 ${current === i ? 'w-10 bg-accent' : 'w-6 bg-utility-gray/20 hover:bg-accent/40'}`}
...
<button
  type="button"
  onClick={prevSlide}
  className="w-11 h-11 border border-white/20 flex items-center justify-center text-secondary hover:bg-utility-gray/10 transition-all"
