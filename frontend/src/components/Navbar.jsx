    ...
    <nav className={`fixed w-full z-[80] transition-all duration-500 ${scrolled ? 'py-4 glass shadow-2xl' : 'py-8 bg-transparent'}`}>
      <div className="container mx-auto px-6 flex justify-between items-center">
        ...
        <Link to="/">
          ...
          >
            <img
              src="/elijays-logo.png"
              alt="ELIJAY'S Men's Wear"
              className="h-11 w-11 lg:h-14 lg:w-14 rounded-full object-cover ring-2 ring-gold-500/50 shadow-lg shadow-gold-500/10 bg-black"
            />
            <span className="hidden sm:block text-lg lg:text-2xl font-serif tracking-[0.12em] lg:tracking-[0.16em] font-semibold text-gradient-gold leading-tight">
              ELIJAY&apos;S
              <span className="block text-[10px] lg:text-xs tracking-[0.35em] font-sans font-normal text-gold-400/80 mt-0.5">Men&apos;s Wear</span>
            </span>
          </motion.div>
        </Link>
