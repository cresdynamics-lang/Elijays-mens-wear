...
const Footer = () => {
  return (
    <footer className="bg-black pt-24 pb-14 border-t border-white/10">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 mb-20">
          <div className="space-y-8">
            <h2 className="text-3xl font-serif font-semibold text-accent tracking-tight">ELIJAY&apos;S</h2>
            <p className="text-secondary dark:text-secondary font-light leading-relaxed max-w-sm">
          ...
          <div>
            ...
            <ul className="space-y-4">
              {['Shirts & Suits', 'Trousers & Khakis', 'Polos & Sweaters', 'Jackets', 'Belts & Ties'].map((link) => (
                <li key={link}>
                   <a href="#" className="text-white hover:text-accent transition-colors duration-300 text-base tracking-wide font-medium">
                     {link}
                   </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4">
              {['Contact Us', 'Bespoke Services', 'Shipping & Returns', 'Size Guide', 'Privacy Policy', 'Staff'].map((link) => (
                <li key={link}>
                  <a href={link === 'Staff' ? '/admin' : '#'} className="text-white hover:text-accent transition-colors duration-300 text-base tracking-wide font-medium">
                    {link}
                  </a>
                </li>
              ))}
        ...
        <div className="flex flex-col md:flex-row justify-between items-center py-10 border-y border-white/10 gap-6">
          ...
          <div className="flex items-center space-x-3 text-secondary">
            ...
            <span className="text-sm font-light">0724-494089</span>
          </div>
          <div className="flex items-center space-x-3 text-secondary">
            <Mail size={18} className="text-accent" />
            <span className="text-sm font-light">contact@elijays.co.ke</span>
          </div>
          <a href={SITE_URL} className="flex items-center space-x-3 text-secondary hover:text-accent transition-colors duration-300">
        ...
        <div className="text-center pt-10">
          <p className="text-xs text-secondary/70 tracking-widest font-light uppercase">
      ...
      >
        ...
        <span className="ml-2 whitespace-nowrap text-secondary dark:text-secondary dark:text-secondary dark:text-secondary dark:text-secondary dark:text-white text-sm font-medium opacity-0 transition-opacity duration-300 group-hover:opacity-100 pr-5">
          WhatsApp
        </span>
      </a>
    </footer>
