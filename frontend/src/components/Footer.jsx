      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 mb-20">
          <div className="space-y-8">
            <h2 className="text-3xl font-serif font-bold text-gradient-gold">ELIJAY&apos;S</h2>
            <p className="text-navy-300 font-light leading-relaxed">
              Luxury menswear for the modern gentleman — tailored suits, refined shirts,
              and finishing details without compromise.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              {['Formal Wear', 'Casual Collection', 'Tailored Suits', 'Linen Basics', 'Accessories'].map((link) => (
                <li key={link}>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center py-12 border-y border-gold-500/10 gap-8">
          <div className="flex items-center space-x-4 text-navy-400">
            ...
            <span className="text-xs">ELIJAY'S Men's Wear, Nairobi</span>
          </div>
          <div className="flex items-center space-x-4 text-navy-400">
          ...
          <div className="flex items-center space-x-4 text-navy-400">
            ...
            <span className="text-xs">contact@elijays.co.ke</span>
          </div>
          <a href={SITE_URL} className="flex items-center space-x-4 text-navy-400 hover:text-gold-400 transition-colors">
            ...
            <span className="text-xs">elijays.co.ke</span>
          </a>
          <a href={SOCIAL_INSTAGRAM} target="_blank" rel="noopener noreferrer" className="flex items-center space-x-4 text-navy-400 hover:text-gold-400 transition-colors">
            ...
            <span className="text-xs">@elijaysmenswear</span>
          </a>
