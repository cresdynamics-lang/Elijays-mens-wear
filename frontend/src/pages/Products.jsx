    ...
    <div className="bg-primary min-h-screen">
      ...
      <main className="pt-28 pb-24">
        <div className="container mx-auto px-6">
          ...
          {fetchError && (
            <p className="text-center text-red-600 dark:text-red-600 dark:text-red-400/70 text-sm py-8">{fetchError}</p>
          )}
          ...
          {!loading && filteredProducts.length === 0 && (
            <div className="text-center py-24 space-y-5">
              ...
              <button
                ...
                className="text-secondary dark:text-secondary dark:text-secondary dark:text-secondary dark:text-secondary dark:text-secondary dark:text-secondary dark:text-white text-[10px] font-semibold border-b border-white/15 pb-1.5 hover:border-white/60 transition-colors duration-300"
              >
                Clear Filters
              </button>
            </div>
