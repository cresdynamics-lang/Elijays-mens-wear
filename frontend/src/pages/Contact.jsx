...
const Contact = () => (
  <Layout>
    <SEO
      ...
      path="/contact"
    />
    <section className="bg-elijays-ink text-white py-14 md:py-20">
      <div className="container mx-auto px-5 md:px-8 max-w-3xl">
        ...
        <p className="text-white/70 font-light">Walk in, call, or WhatsApp — we&apos;ll sort size and stock.</p>
      </div>
    </section>
      ...
      <div className="container mx-auto px-5 md:px-8 grid md:grid-cols-2 gap-12 max-w-5xl">
        <div className="space-y-6">
          <div>
            ...
            <p className="text-sm text-elijays-muted leading-relaxed">
              {STORE.street}<br />{STORE.city}, Kenya
            </p>
            <span className="garment-tag !bg-white mt-4 inline-flex border-elijays-gold text-elijays-gold">{STORE.tag}</span>
          </div>
          <div>
            <h2 className="font-display text-xl text-elijays-ink mb-2">Phone</h2>
            <a href={`tel:${STORE.phone}`} className="text-sm text-elijays-gold hover:text-elijays-ink transition-colors">{STORE.phoneDisplay}</a>
          </div>
          <div>
            <h2 className="font-display text-xl text-elijays-ink mb-2">Email</h2>
            <a href={`mailto:${STORE.email}`} className="text-sm text-elijays-gold hover:text-elijays-ink transition-colors">{STORE.email}</a>
          </div>
          <div>
            <h2 className="font-display text-xl text-elijays-ink mb-2">Hours</h2>
            <ul className="text-sm text-elijays-muted space-y-1">
              {STORE.hours.map((h) => (
        ...
        <div className="bg-elijays-charcoal min-h-[280px] flex flex-col items-center justify-center p-8 text-center gap-4">
          <p className="font-display text-elijays-ink text-xl">Muindi Mbingu × Biashara</p>
          <p className="text-elijays-muted text-sm font-light max-w-xs">
