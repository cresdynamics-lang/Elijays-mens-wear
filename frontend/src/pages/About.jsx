...
const About = () => (
  <Layout>
    <SEO
      ...
      path="/about"
    />
    <section className="bg-elijays-black text-elijays-white py-16 md:py-24 border-b border-elijays-gold/30">
      <div className="container mx-auto px-5 md:px-8 max-w-3xl">
        ...
        <p className="text-elijays-white/75 text-[15px] leading-relaxed font-light mb-4">
        ...
        <p className="text-elijays-white/75 text-[15px] leading-relaxed font-light">
    ...
    <section className="py-14 md:py-20 bg-elijays-white">
      <div className="container mx-auto px-5 md:px-8 grid md:grid-cols-2 gap-10 max-w-5xl">
        ...
        <div>
          ...
          <p className="text-sm text-[#5c5c5c] leading-relaxed font-light mb-4">
