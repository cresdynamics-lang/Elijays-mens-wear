...
export const buildRichDescription = (product, variantMeta = {}, parentCategoryName = '') => {
  ...
  const intro = parsed.intro.length
    ...
    : [
        ...
        `Whether you are building a capsule wardrobe or adding a statement piece, ${name} delivers the refined finish ELIJAY'S Men's Wear is known for across Nairobi and beyond.`,
      ];
